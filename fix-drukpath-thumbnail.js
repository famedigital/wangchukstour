// Fix Druk Path Trek thumbnail (broken image)
...
async function fixDrukPathThumbnail() {
  ...
  try {
    ...
    console.log('✅ Successfully fixed Druk Path Trek thumbnail!');
    ...
    console.log('Fixed thumbnail URL:', tour.thumbnail_url);
    console.log('Fixed thumbnail public ID:', tour.thumbnail_public_id);
